  ...
  return (
    <>
      ...
      <section style={{ position: "relative", height: "420px", display: "flex", alignItems: "flex-end", paddingBottom: "56px", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, rgba(232,180,0,0.82) 0%, rgba(10,10,10,0.78) 100%)" }} />
        ...
        <div className="site-wrap" style={{ position: "relative", zIndex: 10 }}>
          <h1 style={{ fontSize: "clamp(2.2rem,5vw,3.6rem)", fontWeight: 900, color: "#fff", marginBottom: "12px", lineHeight: 1.1 }}>
            <span style={{ color: "#e8b400" }}>C</span>ontac<span style={{ color: "#e8b400" }}>t</span>
          </h1>
      ...
      <section style={{ background: "#f8f9fb", padding: "72px 0" }}>
        <div className="site-wrap">
          <div style={{ display: "grid", gap: "20px", marginBottom: "20px" }} className="sm:grid-cols-2">
            {[{ icon: Phone, label: "Phone", value: "+91 91049 63161", href: "tel:+919104963161" }, { icon: Mail, label: "Email", value: "info@jkbrandingindia.com", href: "mailto:info@jkbrandingindia.com" }].map(({ icon: Icon, label, value, href }) => (
              <a key={label} href={href} style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "10px", padding: "36px 24px", background: "#fff", border: "1px solid rgba(0,0,0,0.07)", textDecoration: "none", transition: "border-color 0.2s", textAlign: "center" }} className="hover:border-[#e8b400]/50 card-hover">
                <div style={{ width: "52px", height: "52px", borderRadius: "50%", background: "#fef3c7", display: "flex", alignItems: "center", justifyContent: "center" }}><Icon size={22} style={{ color: "#e8b400" }} /></div>
                <div>
          ...
          <div style={{ display: "grid", gap: "20px" }} className="sm:grid-cols-2 lg:grid-cols-3">
            {branches.map(b => (
              <div key={b.city} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "10px", padding: "36px 24px", background: "#fff", border: "1px solid rgba(0,0,0,0.07)", textAlign: "center", transition: "border-color 0.2s" }} className="hover:border-[#e8b400]/50 card-hover">
                <div style={{ width: "52px", height: "52px", borderRadius: "50%", background: "#fef3c7", display: "flex", alignItems: "center", justifyContent: "center" }}><MapPin size={22} style={{ color: "#e8b400" }} /></div>
                <p style={{ fontWeight: 800, color: "#1a1a1a", fontSize: "15px" }}>{b.label}</p>
                <p style={{ color: "#777", fontSize: "13px", lineHeight: 1.7 }}>{b.address}</p>
                <p style={{ color: "#e8b400", fontWeight: 700, fontSize: "13px" }}>Contact No : {b.phone}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ background: "#fff", padding: "80px 0" }}>
        <div className="site-wrap">
          <div style={{ textAlign: "center", marginBottom: "52px" }}>
            <span style={{ color: "#e8b400", fontSize: "11px", fontWeight: 700, letterSpacing: "4px", textTransform: "uppercase" }}>CONTACT</span>
          ...
          <div style={{ display: "grid", gap: "60px", alignItems: "center" }} className="lg:grid-cols-2">
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "24px" }}>
              <div style={{ width: "100%", maxWidth: "420px", background: "linear-gradient(135deg,#fef3c7 0%,#fffbeb 100%)", border: "2px solid rgba(232,180,0,0.2)", padding: "40px 32px", textAlign: "center", position: "relative" }}>
                <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "4px", background: "linear-gradient(90deg,#e8b400,#f5d020,#e8b400)" }} />
                <div style={{ width: "80px", height: "80px", borderRadius: "50%", background: "#e8b400", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="#000" strokeWidth="2" width="36" height="36"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.44a2 2 0 0 1 1.95-2.18h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6 6l.91-.91a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
                </div>
                ...
                <div style={{ display: "inline-block", padding: "10px 28px", background: "#e8b400", color: "#000", fontWeight: 800, borderRadius: "999px", fontSize: "14px" }}>Questions?</div>
                <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px", marginTop: "24px" }}>
                  {["Graphic Design", "Digital Marketing", "Website Dev", "SEO", "Branding"].map(tag => (
                    <span key={tag} style={{ padding: "5px 12px", background: "#fff", border: "1px solid rgba(232,180,0,0.3)", borderRadius: "999px", fontSize: "12px", color: "#555", fontWeight: 500 }}>{tag}</span>
                  ))}
                </div>
              </div>
              <div style={{ textAlign: "center" }}>
                ...
                <div style={{ display: "flex", gap: "10px", justifyContent: "center" }}>
                  {[SocialFacebook, SocialLinkedin, SocialInstagram, SocialYoutube].map((Icon, i) => (
                    <a key={i} href="#" style={{ width: "40px", height: "40px", borderRadius: "50%", border: "1.5px solid #e5e7eb", background: "#fff", display: "flex", alignItems: "center", justifyContent: "center", color: "#888", transition: "all 0.2s" }} className="hover:border-[#e8b400] hover:text-[#e8b400]"><Icon /></a>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div style={{ background: "#fff", border: "1px solid rgba(0,0,0,0.08)", padding: "44px 40px", position: "relative", overflow: "hidden" }}>
              ...
              <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                <div><label style={{ display: "block", color: "#555", fontSize: "13px", fontWeight: 600, marginBottom: "6px" }}>Name :</label><input type="text" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} required placeholder="Name" style={iBase} onFocus={e => (e.target.style.borderColor = "#e8b400")} onBlur={e => (e.target.style.borderColor = "#e5e7eb")} /></div>
                <div><label style={{

                  color: "#555", fontSize: "13px", fontWeight: 600, marginBottom: "6px"
                }}>Email :</label><input type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} required placeholder="Email" style={iBase} onFocus={e => (e.target.style.borderColor = "#e8b400")} onBlur={e => (e.target.style.borderColor = "#e5e7eb")} /></div>
                <div><label style={{ display: "block", color: "#555", fontSize: "13px", fontWeight: 600, marginBottom: "6px" }}>Contact No :</label><input type="tel" value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value })} placeholder="Contact Number" style={iBase} onFocus={e => (e.target.style.borderColor = "#e8b400")} onBlur={e => (e.target.style.borderColor = "#e5e7eb")} /></div>
                <div><label style={{ display: "block", color: "#555", fontSize: "13px", fontWeight: 600, marginBottom: "6px" }}>Message :</label><textarea value={form.message} onChange={e => setForm({ ...form, message: e.target.value })} required rows={4} placeholder="Message" style={{ ...iBase, resize: "none" }} onFocus={e => (e.target.style.borderColor = "#e8b400")} onBlur={e => (e.target.style.borderColor = "#e5e7eb")} /></div>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", padding: "12px 16px", border: "1.5px solid #e5e7eb", background: "#f9fafb" }}>
                  <input type="checkbox" id="robot" style={{ width: "18px", height: "18px", accentColor: "#e8b400", cursor: "pointer" }} />
                  <label htmlFor="robot" style={{ color: "#555", fontSize: "13px", cursor: "pointer", flex: 1 }}>I&apos;m not a robot</label>
                </div>
                <button type="submit" style={{ width: "100%", padding: "15px", background: sent ? "#22c55e" : "#e8b400", color: sent ? "#fff" : "#000", border: "none", fontWeight: 800, fontSize: "15px", letterSpacing: "1px", textTransform: "uppercase", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", transition: "background 0.2s" }}>
      ...
      <section style={{ background: "#f8f9fb" }}>
        <div className="site-wrap">
          <div style={{ overflow: "hidden", border: "1px solid rgba(0,0,0,0.06)" }}>
            <iframe title="JK Branding Location" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.674988085254!2d70.7725!3d22.2775!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3959c98ac71cdf0f%3A0x76dd10be3c4e5b34!2sJK%20Branding%20(India)%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin" width="100%" height="420" style={{ border: 0, display: "block" }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
        </div>
      </section>
